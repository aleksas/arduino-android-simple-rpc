...
public class SerialService extends Service implements SerialListener {
     ...
     * Api
     */
    public void connect(SerialSocket socket, Interface iface) throws IOException {
...
//                case Read:          listener.onSerialRead         (item.data); break;
    ...
    private void createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            disconnectPendingIntent = PendingIntent.getBroadcast(this, 1, disconnectIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
            restartPendingIntent = PendingIntent.getActivity(this, 1, restartIntent,  PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        }else {
    ...
    public Object call_method(String methodName, Object... arguments) throws IOException {
        return iface.call_method(methodName, arguments);
    }
                ...
                try {
                    ...
                    synchronized (this) {
                        if (listener != null) {
                            mainLooper.post(() -> {
                                if (listener != null) {
                                    listener.onMethodsRead(iface.device.methods.values());
                                }
                            });
                        }
                    }
